...
public class Array {
    ...
    public String [] mesAnio = {"enero", "febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"};
   // public String mesSecrecto = mesAnio [(int)(Math.random()*(12+1))];
    public String mesSecreto = mesAnio [3];
    public Array() {
    }
